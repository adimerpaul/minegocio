...
/// Devuelve el producto creado al hacer pop.
class ProductoCrearPage extends StatefulWidget {
  final Session session;
  final List<Categoria> categorias;

  const ProductoCrearPage({
    super.key,
  ...
  @override
  State<ProductoCrearPage> createState() => _ProductoCrearPageState();
}

class _ProductoCrearPageState extends State<ProductoCrearPage> {
  final _formKey = GlobalKey<FormState>();
  final TextEditingController _nombre = TextEditingController();
  final TextEditingController _precio = TextEditingController(text: '0.00');
  final TextEditingController _stock = TextEditingController(text: '0');
  final TextEditingController _stockMinimo = TextEditingController(text: '5');
  ...
  Future<void> _guardar() async {
    ...
    try {
      final creado = await ProductoService.instance.crear(
